...
# Create dummy user
User1 = User(name="Vladimir Vorotnikov", email="v.s.vorotnikov@gmail.com",
...
session.add(category1)
session.commit()
category1 = Category(user_id=1, name="Health")
session.add(category1)
session.commit()
category1 = Category(user_id=1, name="History")
session.add(category1)
session.commit()
category1 = Category(user_id=1, name="Humor")
session.add(category1)
session.commit()
...
session.add(category1)
session.commit()
category1 = Category(user_id=1, name="Romance")
session.add(category1)
session.commit()
